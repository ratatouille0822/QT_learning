...
QT_MOC_LITERAL(1, 11, 23), // "backToChooselevelWindow"
QT_MOC_LITERAL(2, 35, 0) // ""

    },
    "PlayWindow\0backToChooselevelWindow\0"
};
...
void PlayWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->backToChooselevelWindow(); break;
        default: ;
        }
        ...
        {
            typedef void (PlayWindow::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&PlayWindow::backToChooselevelWindow)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void PlayWindow::backToChooselevelWindow()
{
